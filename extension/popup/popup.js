      ...
      <div class="vp-h-left">
        <div class="vp-logo">
          <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="vg-popup" x1="0" y1="0" x2="1" y2="1">
            ...
            <g transform="translate(115, 115)">
              <circle cx="0" cy="0" r="56" fill="none" stroke="url(#vg-popup)" stroke-width="14"/>
              <path d="M -24 -15 L 0 25 L 24 -15" fill="none" stroke="url(#vg-popup)" stroke-width="14" stroke-linecap="round" stroke-linejoin="round"/>
              <line x1="42" y1="42" x2="80" y2="80" stroke="url(#vg-popup)" stroke-width="14" stroke-linecap="round"/>
            </g>
          </svg>
        </div>
        <div>
